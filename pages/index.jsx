...
export default function Home() {
  ...
  const navItems = [
    ...
    { icon: '🏙️', title: 'Edmonton', desc: "Things to do, eat, and explore in Edmonton, Alberta.", href: '/edmonton' },
    { icon: '⚙️', title: 'Admin', desc: 'Hermes Agent admin dashboard - manage cron jobs, memory, and configuration.', href: '/admin.html' },
    { icon: '🛍️', title: 'Product Roundup', desc: 'Curated product summaries and images.', href: '/product-roundup' },
  ]
        ...
        <div style={{ ...s.content, ...s.containerEntrance }}>
          ...
          <header style={s.hero}>
            ...
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: 8, marginTop: 16, padding: '8px 20px', borderRadius: 24, background: 'rgba(134, 196, 118, 0.02371615110147546)', border: '1px solid rgba(134, 196, 118, 0.15)', fontSize: 13, color: v.textSecondary }}>
              ...
              <span style={{ fontWeight: 600, color: v.textPrimary }}>Saturday, August 1, 2026 · Updated at 09:01:47 AM PDT</span>
            </div>
          </header>
