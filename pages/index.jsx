...
export default function Home() {
  ...
  const navItems = [
    { icon: '🎮', title: 'Games', desc: "Sky Fighter ✈️ · Tetris · Breakout · Heads Up — arcade games with mobile touch controls.", href: '/games' },
    ...
    { icon: '🎈', title: 'Balloon Pop', desc: 'Tap to inflate, lock in before it pops. 30 seconds, and every balloon pops at a different size.', href: '/balloon' },
    ...
    { icon: '⚡', title: 'EV vs Gas', desc: "Plug in your local gas & electricity prices and see how much cheaper your Honda Clarity PHEV is to run — with the real EPA numbers.", href: '/ev-vs-gas' },
  ]
